...
<head>
    ...
    <title>Nouveau commentaire sur votre demande de badge</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Un nouveau commentaire a été ajouté sur votre demande de badge.</p>
            ...
            <center>
                <a href="{{ config('frontend.url') }}/badge-requests/{{ $badge_request->id }}" class="button">
                    Voir la demande de badge
                </a>
            </center>
        </div>
