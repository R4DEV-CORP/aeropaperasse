...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="warning">
                <p>Nous vous informons que votre badge n°{{ $badge_number }} a <span class="expired">expiré</span> depuis le {{ date('d/m/Y', strtotime($expiry_date)) }}.</p>
            </div>
            ...
            <div class="info-section">
                ...
                <div class="info-box">
                    ...
                    <div class="info-item">
                        ...
                        <span class="value expired">{{ date('d/m/Y', strtotime($expiry_date)) }}</span>
                    </div>
                </div>
            </div>
            
            <p>Votre badge ne vous permet plus d'accéder aux zones autorisées. Si vous avez besoin de continuer à accéder à ces zones, veuillez effectuer une demande de renouvellement dès que possible.</p>
            
            <p>Nous vous rappelons également que vous êtes tenu(e) de restituer ce badge dans les plus brefs délais.</p>
