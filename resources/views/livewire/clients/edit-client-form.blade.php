<form wire:submit="updateClient" class="space-y-6">
    <div>
        <div class="flex items-center gap-2">
            ...
            <flux:heading size="lg">Modifier la société</flux:heading>
        </div>
        <flux:text class="mt-2">Modifiez les informations de la société.</flux:text>
    </div>
    ...
    <div class="border border-gray-800/10 p-4 rounded-lg">
        ...
        @if($hasExistingKbis || $hasExistingSafety || $hasExistingSecurity)
            <flux:callout class="mt-4" icon="information-circle" color="blue">
                <flux:callout.heading>Des documents existent déjà pour ce client. Vous pouvez les remplacer en téléchargeant de nouveaux fichiers, sinon les documents existants seront conservés.</flux:callout.heading>
            </flux:callout>
        @endif
        ...
        <div class="grid grid-cols-3 gap-4 mt-4">
            <flux:field>
                ...
                <flux:input type="file" icon="document-plus" wire:model="kbis_document" name="kbis_document" />
            ...
            <flux:field>
                ...
                <flux:input type="file" icon="document-plus" wire:model="safety_document" name="safety_document" />
            ...
            <flux:field>
                ...
                <flux:input type="file" icon="document-plus" wire:model="security_document" name="security_document" />
    ...
    <div class="flex gap-2 mt-4">
        ...
        <flux:button type="submit" variant="primary" icon="check">Mettre à jour la société</flux:button>
    </div>
</form>
