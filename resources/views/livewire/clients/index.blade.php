<div class="mt-8">
    <div class="flex items-center gap-3 mt-4">
        <flux:input icon="magnifying-glass" placeholder="Rechercher une société..." />
            ...
            <table class="min-w-full divide-y divide-slate-800/10">
                ...
                <tbody class=" divide-slate-800/10 text-sm text-gray-700">
                    <tr>
                        ...
                        <td class="px-3 py-2">
                            <p class="text-gray-800 font-medium">10</p>
                        </td>
...
<script>
    document.addEventListener('livewire:initialized', () => {
        Livewire.on('close-modal', (modalName) => {
            // Utiliser l'API FluxUI pour fermer la modal
            if (window.Flux && window.Flux.modal) {
                window.Flux.modal.close(modalName);
            } else {
                // Fallback : utiliser l'événement personnalisé FluxUI
                window.dispatchEvent(new CustomEvent('flux:modal:close', {
